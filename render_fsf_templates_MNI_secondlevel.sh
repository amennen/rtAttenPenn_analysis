...
render_secondlevel_faces $FSF_DIR/faces_MNI.fsf.template \
                  $SUBJECT_DIR_SECONDLEVEL/${SES}/faces_MNI.gfeat \
                  $SUBJECT_DIR_FIRSTLEVEL/${SES}/faces1_MNI.feat \
                  $SUBJECT_DIR_FIRSTLEVEL/${SES}/faces2_MNI.feat > $SUBJECT_DIR_SECONDLEVEL/${SES}/faces_MNI.fsf
