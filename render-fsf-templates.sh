...
render_firstlevel_faces $FSF_DIR/faces.fsf.template \
                  $SUBJECT_DIR/${SES}/faces${runNumber}.feat \
                  $FMRIPREP_DIR/${SUBJECT}/${SES}/func/${SUBJECT}_${SES}_task-faces_rec-uncorrected_${RUN}_bold_space-T1w_preproc.nii.gz \
                  ...
                  $FIRSTLEVEL_DIR/timing_files/${SUBJECT}/${SES}/${char}_object.txt > $FIRSTLEVEL_DIR/${SUBJECT}/${SES}/faces${runNumber}.fsf
