...
command = ("3dttest++ -setA {0} ".format(MDD_subj_str) +
            ...
            "-prefix {0}/{1}/{1}_stats_fearful_diff_dmn_yeo.ttest.nii.gz ".format(second_level,ses_id) +
            "-AminusB " 
            "-covariates {0} ".format(covar_file) +
            "-prefix_clustsim {0}_stats_fearful_diff_dmn_yeo ".format(ses_id) +
            "-mask {0} ".format(dmn_gm_mask) +
            "-Clustsim "
            )
