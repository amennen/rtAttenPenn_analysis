...
render_firstlevel_faces $FSF_DIR/faces_MNI.fsf.template \
                  $SUBJECT_DIR/${SES}/faces${runNumber}_T1w_final.feat \
                  ...
                  $FIRSTLEVEL_DIR/timing_files/${SUBJECT}/${SES}/${char}_object.txt > $FIRSTLEVEL_DIR/${SUBJECT}/${SES}/faces${runNumber}_T1w_final.fsf
